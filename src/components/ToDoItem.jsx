  ...
  return (
    <>
      <div className="w-full">
        ...
        <div
          className={`mx-4 sm:mx-20 border-2 border-gray-300 rounded-lg p-4 sm:p-6 flex gap-4 items-center shadow-md my-2 sm:my-4
        ...
        >
          ...
          {edit ? (
            ...
            <div className="text-gray-700 text-sm sm:text-2xl font-bold flex gap-3 md:gap-10 w-2/3 ">
              {props.data.id}
          ...
          <div className="flex items-center gap-3 sm:gap-6 w-1/3 justify-end">
