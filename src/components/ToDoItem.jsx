...
const ToDoItem = (props) => {
  ...
  return (
    <>
      ...
      <div
        className={`border-2 border-gray-300 rounded-lg p-4 sm:p-6 flex gap-4 items-center bg-white shadow-md mx-4 sm:mx-20 my-2 sm:my-4
          ${props.data.completed ? 'bg-green-100' : 'bg-white'}  // Green background if completed
          ${edit ? 'sm:flex-wrap' : 'flex'}`}  // Adjust layout if in edit mode
      >
